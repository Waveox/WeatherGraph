...
const Button = ({
  ...
  let classes =
    'inline-flex items-center px-4 py-2 border border-transparent rounded-md font-semibold text-xs uppercase tracking-widest focus:outline-none focus:ring-2 focus:ring-offset-2 transition weathergraph-in-out duration-150 disabled:opacity-50 disabled:cursor-not-allowed ';
